                            ...
                            <div className='relative w-[379px] h-[379px] px-5 flex items-center justify-center' >
                                <div className='absolute top-0 left-0 w-full h-full '>
                                    <svg width="100%" height="100%" viewBox="0 0 369 369" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path fillRule="evenodd" clipRule="evenodd" d="M364 0H353V5H364V16H369L369 5V0H364Z" fill="#333" />
                                        <path fillRule="evenodd" clipRule="evenodd" d="M5 0H16V5H5V16H9.53674e-07L0 5V0H5Z" fill="#333" />
                                        <path fillRule="evenodd" clipRule="evenodd" d="M364 369H353V364H364V353H369L369 364V369H364Z" fill="#333" />
                                        <path fillRule="evenodd" clipRule="evenodd" d="M5 369H16V364H5V353H9.53674e-07L0 364V369H5Z" fill="#333" />
                                        <rect width="16" height="5" transform="matrix(-4.37114e-08 -1 -1 4.37114e-08 369 183)" fill="#333" />
                                        <rect width="16" height="5" transform="matrix(-4.37114e-08 -1 -1 4.37114e-08 5 183)" fill="#333" />
                                ...
                                <div className='flex items-center space-x-3'>
                                    <div className='w-10 h-10 flex items-center justify-center rounded-full bg-green-500'>
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M10 0C4.47715 0 0 4.47715 0 10C0 15.5228 4.47715 20 10 20C15.5228 20 20 15.5228 20 10C20 4.47715 15.5228 0 10 0ZM10 18.75C5.17875 18.75 1.25 14.8212 1.25 10C1.25 5.17875 5.17875 1.25 10 1.25C14.8212 1.25 18.75 5.17875 18.75 10C18.75 14.8212 14.8212 18.75 10 18.75Z" fill="white" />
                                            <path d="M10 3.75C6.875 3.75 4.375 6.25 4.375 9.375C4.375 12.5 6.875 15 10 15C13.125 15 15.625 12.5 15.625 9.375C15.625 6.25 13.125 3.75 10 3.75ZM10 13.75C7.5 13.75 5.625 11.875 5.625 9.375C5.625 6.875 7.5 5 10 5C12.5 5 14.375 6.875 14.375 9.375C14.375 11.875 12.5 13.75 10 13.75Z" fill="white" />
                                            <path d="M10 6.25C8.4375 6.25 7.1875 7.5 7.1875 9.0625C7.1875 10.625 8.4375 11.875 10 11.875C11.5625 11.875 12.8125 10.625 12.8125 9.0625C12.8125 7.5 11.5625 6.25 10 6.25ZM10 10.625C9.375 10.625 8.75 9.9375 8.75 9.0625C8.75 8.1875 9.375 7.5 10 7.5C10.625 7.5 11.25 8.1875 11.25 9.0625C11.25 9.9375 10.625 10.625 10 10.625Z" fill="white" />
                                        </svg>
                                    </div>
                        ...
                        <div className='col-span-1'>
                            <div className='flex flex-col space-y-5 px-5'>
                                ...
                                <div className='px-14 relative'>
                                    ...
                                    <Skill lang="SCSS" blurColor='bg-yellow-500' lineColor='border-yellow-500/70' dotColor='border-yellow-500' />
                                    <Skill lang="Bootstrap 5" blurColor='bg-yellow-500' lineColor='border-yellow-500/70' dotColor='border-yellow-500' />
                                    <Skill lang="Tailwind CSS" blurColor='bg-yellow-500' lineColor='border-yellow-500/70' dotColor='border-yellow-500' />
                                    <Skill lang="Styled Component" blurColor='bg-yellow-500' lineColor='border-yellow-500/70' dotColor='border-yellow-500' />
                                    <Skill lang="CSS 3" blurColor='bg-yellow-500' lineColor='border-yellow-500/70' dotColor='border-yellow-500' />
                        ...
                        <div className='col-span-1'>
                            <div className='flex flex-col space-y-5 px-5'>
                                ...
                                <div className='px-14 relative'>
                                    ...
                                    <Skill lang="Express JS" blurColor='bg-purple-500' lineColor='border-purple-500/70' dotColor='border-purple-500' />
                                    <Skill lang="SocketIO" blurColor='bg-purple-500' lineColor='border-purple-500/70' dotColor='border-purple-500' />
                                    <Skill lang="MongoDB" blurColor='bg-purple-500' lineColor='border-purple-500/70' dotColor='border-purple-500' />
                                    <Skill lang="Mongoose" blurColor='bg-purple-500' lineColor='border-purple-500/70' dotColor='border-purple-500' />
                                    <Skill lang="GraphQL" blurColor='bg-purple-500' lineColor='border-purple-500/70' dotColor='border-purple-500' />
