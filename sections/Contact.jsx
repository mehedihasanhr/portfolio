...
const Contact = () => {
    return (
        <section className="relative" id="contact-me">
                            ...
                            <div className="flex flex-col items-center">
                                <div className="w-full max-w-[600px]">
                                    <div className="block w-fit relative mb-10">
                                        ...
                                        <h3 className="font-bold">
                                            Contact <span className="text-green-500">Form</span>
                                        </h3>
                                    </div>
                                    {/* form */}
                            ...
                            <div className="flex flex-col mt-3">
                                <div className="w-full max-w-[600px]">
                                    <div className="block w-fit relative mb-10">
                                        ...
                                        <h3 className="font-bold">
                                            Social <span className="text-green-500">Links</span>
                                        </h3>
                                    </div>
