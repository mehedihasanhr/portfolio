    ...
    return (
        <section id="hero-section" className="" ref={ref}>
            <div className="container">
                <div className="flex flex-col justify-center -mt-24 sm:-mt-20 h-screen">
                    ...
                    <div className="mb-10">
                        ...
                        <p className="text-sm sm:text-base max-w-[650px]">
                    ...
                    <GraphIcon className='w-48 h-48 sm:w-72 sm:h-72 absolute top-1/2 right-1/4 translate-x-1/2 -translate-y-1/2 pointer-events-none select-none z-1' />
                </div>
            </div>
        </section>
    )
